...
export const fetchBloodRequests = async (filters: {
  search?: string;
  bloodGroup?: string;
  urgencyLevel?: string;
  page?: number;
  ...
  try {
    const params = {
      ...
      ...(filters.bloodGroup && filters.bloodGroup !== 'all' && { bloodGroup: filters.bloodGroup }),
      ...(filters.urgencyLevel && filters.urgencyLevel !== 'all' && { urgencyLevel: filters.urgencyLevel }),
      page: filters.page || 1,
